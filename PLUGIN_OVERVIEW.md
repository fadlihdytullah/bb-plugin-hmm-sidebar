Hmm Sidebar adds a calm, compact project organizer to BB's left
sidebar. Collections stay at the top, while projects that have not been filed
remain in the same flat list shape as BB's native sidebar.
